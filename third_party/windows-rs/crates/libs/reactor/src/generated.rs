...
pub(crate) struct BorderEvents {
    ...
    on_pointer_wheel_changed: Option<Callback<PointerEventInfo>>,
...
pub mod public {
    ...
    impl TextBlock {
        ...
        /// Native WinUI FontFamily source, e.g. "Microsoft YaHei UI, Segoe UI".
        pub fn font_family(mut self, value: impl Into<String>) -> Self {
            self.font_family = Property::Set(value.into());
            self
        }
        pub fn font_family_optional<T: Into<String>>(mut self, value: Option<T>) -> Self {
            self.font_family = Property::from(value.map(Into::into));
            self
        }
    ...
    impl Border {
        ...
        pub fn resource_overrides(mut self, value: impl Into<Option<ResourceOverrides>>) -> Self {
            self.resource_overrides = Property::from(value.into());
            self
        }
        pub fn element_ref(mut self, reference: &ElementRef<Self>) -> Self {
            self.reference = Some(reference.binding());
        ...
        pub fn on_pointer_wheel_changed(
            mut self,
            callback: impl IntoPayloadCallback<PointerEventInfo>,
        ) -> Self {
            std::rc::Rc::make_mut(
            ...
            .on_pointer_wheel_changed = Some(callback.into_payload_callback());
            self
        }
    ...
    impl NumberBox {
        ...
        pub fn small_change(mut self, value: impl Into<Option<f64>>) -> Self {
            let value = value.into();
            assert!(
                value.is_none_or(|step| step.is_finite() && step > 0.0),
                "NumberBox step must be finite and positive"
            );
            self.small_change = Property::from(value);
            self
        }
            ...
            match (self, props) {
                (Self::TextBlock(value), MountedProps::TextBlock(mounted)) => {
                    value.text == mounted.text
                        ...
                        && value.font_family == mounted.font_family
                ...
                (Self::NumberBox(value), MountedProps::NumberBox(mounted)) => {
                    f64_property_eq(&value.small_change, &mounted.small_change)
                ...
                Self::Border(value) => {
                    ...
                    visit(
                        ...
                        value
                            .events
                            .as_ref()
                            .is_some_and(|events| events.on_pointer_wheel_changed.is_some()),
                    );
                    visit(
    ...
    fn visit_properties(&self, visit: &mut dyn FnMut(PropertyId, Option<PropertyValueRef<'_>>)) {
        match self {
            Self::TextBlock(values) => {
                ...
                visit(
                    PropertyId::TextBlockFontFamily,
                    match &values.font_family {
                        Property::Inherited => None,
                        Property::Set(value) => Some(PropertyValueRef::Str(value.as_str())),
                    },
                );
            ...
            Self::NumberBox(values) => {
                visit(
                    PropertyId::NumberBoxSmallChange,
                    match &values.small_change {
                        Property::Inherited => None,
                        Property::Set(value) => Some(PropertyValueRef::F64(*value)),
                    },
                );
    ...
    fn dispatch_event(&self, event: EventId, payload: &EventPayload) -> Option<bool> {
        match (self, event, payload) {
            ...
            (
                ...
                .events
                .as_ref()
                .and_then(|events| events.on_pointer_wheel_changed.as_ref())
                .map(|callback| callback.call(*value)),
            (
                Self::Border(values),
                EventId::BorderPointerMoved,
...
impl PartialEq for NumberBoxMountedProps {
    fn eq(&self, other: &Self) -> bool {
        f64_property_eq(&self.small_change, &other.small_change)
